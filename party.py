...
def is_mel(name, email):
    ...
    >>> is_mel("Mel Melitpolski", "silly_email@gmail.com")
    True

    >>> is_mel("Bunny Jones", "mel@ubermelon.com")
    True
    """
...
def most_and_least_common_type(treats):
    ...
    >>> treats1=[{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'}]
    >>> most_and_least_common_type(treats1)
    ('dessert', 'dessert')

    >>> treats2=[{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'drink'},{'type': 'drink'},{'type': 'drink'}]
